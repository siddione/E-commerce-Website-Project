    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 product-card">
                <a href="product12.php"><img src="prod1.jpg" alt="Product 2" class="img-fluid"></a>
                <div class="product-name">Cartier Baignoire</div>
            </div>

            <!-- Product 3 -->
            <div class="col-lg-3 col-md-4 col-sm-6 product-card">
                <a href="product13.php"><img src="prod2.jpg" alt="Product 3" class="img-fluid"></a>
                <div class="product-name">Cartier Drive de Cartier</div>
            </div>

            <!-- Product 4 -->
            <div class="col-lg-3 col-md-4 col-sm-6 product-card">
                <a href="product14.php"><img src="prod3.jpg" alt="Product 4" class="img-fluid"></a>
                <div class="product-name">Cartier Silver Delux Vintage</div>
            </div>

            <!-- Product 5 -->
            <div class="col-lg-3 col-md-4 col-sm-6 product-card">
                <a href="product15.php"><img src="prod4.jpg" alt="Product 5" class="img-fluid"></a>
                <div class="product-name">Casio Vintage</div>
            </div>

            <!-- Product 6 -->
            <div class="col-lg-3 col-md-4 col-sm-6 product-card">
                <a href="product16.php"><img src="prod5.jpg" alt="Product 6" class="img-fluid"></a>
                <div class="product-name">Rolex Day-Date 40</div>
            </div>

            <!-- Product 7 -->
            <div class="col-lg-3 col-md-4 col-sm-6 product-card">
                <a href="product17.php"><img src="prod6.jpg" alt="Product 7" class="img-fluid"></a>
                <div class="product-name">Rolex Milgauss</div>
            </div>

            <!-- Product 8 -->
            <div class="col-lg-3 col-md-4 col-sm-6 product-card">
                <a href="product18.php"><img src="prod7.jpg" alt="Product 8" class="img-fluid"></a>
